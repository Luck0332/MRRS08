...
<<<<<<< HEAD
                    ...
                    <button id="detail" type="submit" class="fa-solid btn fa-magnifying-glass ml-2" style="text-decoration: none; padding-bottom: 20px;"></button>
=======
            ...
            <div style="text-align: center;">
                ...
                <div style="display: inline-block; vertical-align: top; margin-left: 20px; font-size: ">
                    ...
                    <br>
                        ...
                        @csrf
                        @method('PUT')
                        <button type="submit" name="newStatus" value="C"class="btn btn-danger large-button" style="height: 38px;"
                            >ยกเลิกการจอง</button>
                    </form>
                    ...
                    @elseif ($re->res_status == 'A')
                        ...
                        @csrf
                        @method('PUT')
                        <button type="submit" name="newStatus" value="Z"class="btn btn-danger large-button" style="height: 38px;"
                            >ยกเลิกการจอง</button>
                    </form>
...
=======
                                    ...
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" name="newStatus" value="z"
